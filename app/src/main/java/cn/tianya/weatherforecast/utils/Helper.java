...
import static cn.tianya.weatherforecast.utils.C.DEFAULT_CITY;
import static cn.tianya.weatherforecast.utils.C.SP.KEY_CURRENT_CITY;
...
public class Helper {
    ...
    public static City getDefaultCity(SharedPreferences sp) {
        String json = sp.getString(KEY_CURRENT_CITY, DEFAULT_CITY);
